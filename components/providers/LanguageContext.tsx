...
export function LanguageProvider({ children }: { children: ReactNode }) {
    ...
    const setLanguage = (lang: Language) => {
        ...
        // ✅ DO NOT set document.documentElement.dir here
        // That flips the entire layout including sidebar/flexbox
        // RTL is handled per-element using the isRTL flag below
    };
