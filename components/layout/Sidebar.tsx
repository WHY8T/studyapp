...
export function Sidebar({ profile }: SidebarProps) {
  ...
  return (
    <>
      <aside className="w-64 shrink-0 h-screen sticky top-0 flex flex-col border-r border-border bg-card">
            ...
            <div className="rounded-xl bg-muted/50 p-3 space-y-3">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-display font-semibold text-sm truncate max-w-[100px]">
                    {profile.username}
                  </span>
                </div>
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  active
                    ? "bg-lime text-[#0D0D18] font-semibold shadow-sm"
              ...
              >
                ...
                {label}
                {badge && (
                  <span className="ml-auto text-[10px] font-bold px-1.5 py-0.5 rounded-full bg-orange-400/20 text-orange-400">
                    {badge}
                  </span>
                )}
              </Link>
        ...
        {hm && (
          <div className="px-4 pb-2">
            <button
              ...
              className="w-full flex items-center justify-center gap-2 px-3 py-2.5 rounded-xl border border-border hover:bg-muted transition-colors"
        ...
        <div className="p-4 border-t border-border">
          <button
            ...
            className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-muted-foreground hover:bg-destructive/10 hover:text-destructive w-full transition-all duration-200"
          >
      ...
      {clockOpen && (
        <div
          className="fixed inset-0 z-50 bg-[#08080F] flex flex-col items-center justify-center cursor-pointer"
          onClick={() => setClockOpen(false)}
        >
          <button
            onClick={(e) => { e.stopPropagation(); setClockOpen(false); }}
          ...
          <div className="space-y-4 text-center select-none">
            ...
            <div
              ...
              style={{
                ...
                textShadow: "0 0 80px rgba(0,183,255,0.25)",
              }}
            >
              {hms}
            </div>
